                  ...
                  <tbody>
                     <tr>
                        ...
                        <td className="text-center  box-w1 back"> 
						 ...
						 className="odd layprice">EVEN</span>1|2|3|4|5</button>
						</td>
						 <td className="text-center  box-w1 back"> 
						 <button className="back"
					 ...
					 <tr>
                        ...
                        <td className="text-center  box-w1 back"> 
						 ...
						 >	<span className="odd layprice"> Line 2</span>1|2|3|4|5</button>
						</td>
						 <td className="text-center  box-w1 back"> 
						 <button className="back"
						 onClick={this.handleBidClick.bind(this,	"EVEN","9",'#faa9ba')}
						 >	<span className="odd layprice"> EVEN</span>1|2|3|4|5</button>
						</td>
                     </tr>
