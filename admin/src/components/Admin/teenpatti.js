...
<div className="row game_img_man vip-poker">
		 ...
		 <div className="col-2 col-sm-4">
          <a href="/casino/one-day-teenpatti" className="game_img ">
            <img className="img-fluid" src="/img/banners/1day-teenpatti.jpg" />
          </a>
         </div>
		 <div className="col-2 col-sm-4">
          <a href="/casino/teenpatti20" className="game_img">
            <img className="img-fluid" src="/img/banners/20-20-teenpatti.jpg" />
          </a>
         </div>
         </div>
