...
callPermissonData=()=>{
	  ...
	  if(this.state.respStatus===true){ 
		 ...
		 for(var i=0;i<this.state.tabledata.length;i++) {
		  ...
		  var showPercentage = (value.userType==6) ? 0 : value.cricket_partnership_own;
			...
			var newBalnce=(value.balance) +(value.profit_loss)-(value.data_new);
			...
			var mainHtml = <tr role="row" className="odd">
							...
							<a className="btn btn-default" href={"/min-max-bet/"+value._id} >M</a>
								<button className="btn btn-default" onClick={this.handleDepoWithdrPopupOpen.bind(this,newBalnce,value._id,value.username,"deposit")}>D</button>
								<button className="btn btn-default" onClick={this.handleDepoWithdrPopupOpen.bind(this,newBalnce,value._id,value.username,"withdrawal")} >W</button>
								{exposure} 
  ...
  render() {
	...
	var show ="";
	if((value.userType==1 && this.state.customSuperAdmin===false)|| (value.userType==1 && this.state.customSuperAdmin===true && this.state.admin_list===true)){
		var show=<button className="btn btn-default" onClick={this.handleLogout}>Logut From All Child</button>;
	}
	
	var addAccuntButton ="";
	if((this.state.customSuperAdmin===false)|| (value.userType==1 && this.state.customSuperAdmin===true && this.state.admin_list===true)){
		var addAccuntButton = <Link to="/addadmin" className="btn btn-primary">Add Account</Link>;
	}
	
	var roundDownArrow ="";
	if(this.state.customSuperAdmin===false){
		var roundDownArrow = <div className="togglebat_top">
        ...
        <div className="master-balance-detail m-t-20" id="master-balance-detail" style={{display: 'block'}}><ul className="row">
            <li className="col-md-4">
              <label className="col-md-8 text-left  p-0">Upper Level Credit Referance:</label>
              <span className="text-right col-md-4  p-0">{creditreferce}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0">Down level Occupy Balance:</label>
              <span className="text-right col-md-4  p-0">{newbalnce}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0 ">Down Level Credit Referance:</label>
              <span className="text-right col-md-4  p-0">{creditAmount}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0">Total Master Balance</label>
              <span className="text-right col-md-4 p-0">{newamount2}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0">Upper Level:</label>
              <span className="text-right col-md-4 p-0">{newcardit_amount}</span>
            </li>
            <li className="col-md-4">
            ...
            <li className="col-md-4">
              ...
              <span className="text-right col-md-4 p-0">{value.balance +value.profit_loss-value1}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0">Available Balance With Profit/Loss:</label>
              <span className="text-right col-md-4 p-0">{value.balance +value.profit_loss}</span>
            </li>
            <li className="col-md-4">
              <label className="col-md-8 text-left p-0">My Profit/Loss:</label>
              <span className="text-right col-md-4 p-0">{value.profit_loss}</span>
            </li>
          </ul></div>
      </div>
        </div>
		...
		<div className="man_bglight">
		   ...
		   <div id="account-statement_wrapper" className="dataTables_wrapper ">
			  <div className="row">
				 ...
				 <h4 className="a_manh mb-0">Account list</h4>
	...
	<Modal show={this.state.showUserAmountPopup} onHide={this.handleExposureLimitClose}>
		<form className="form loginform" onSubmit={this.handleExposureLimitSubmit}>
			...
			<Modal.Footer>
				...
				<button type="button" className="btn btn-info2" data-dismiss="modal" onClick={this.handleExposureLimitClose}><i className="fas fa-undo-alt"></i> Close</button>
	  ...
	  <Modal show={this.state.showDepoWithdrPopup} onHide={this.handleDepoWithdrPopupClose}>
		...
		{this.emptyDepoWithdrHtml()}
		 <button type="button" className="btn btn-info2" data-dismiss="modal" onClick={this.handleDepoWithdrPopupClose}><i className="fas fa-undo-alt"></i> Close</button>
		  <button type="submit" className="btn btn-primary"><i className="fas fa-paper-plane"></i> Submit</button>	
	...
	<Modal show={this.state.showChangePassPopup} onHide={this.handleChangePassPopupClose}>
		...
		{this.emptyChangePassHtml()}
		 <button type="button" className="btn btn-info2" data-dismiss="modal" onClick={this.handleChangePassPopupClose}><i className="fas fa-undo-alt"></i> Close</button>
		  <button type="submit" className="btn btn-primary"><i className="fas fa-paper-plane"></i> Submit</button>	
	  ...
	  <Modal show={this.state.showBetUserPopup} onHide={this.handleBetUserPopupClose}>
		...
		{this.emptyBetUserHtml()}
		 <button type="button" className="btn btn-info2" data-dismiss="modal" onClick={this.handleBetUserPopupClose}><i className="fas fa-undo-alt"></i> Close</button>
		  <button type="submit" className="btn btn-primary"><i className="fas fa-paper-plane"></i> Submit</button>	
