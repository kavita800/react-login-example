...
<div className="row game_img_man vip-poker">
        <div className="col-2 col-sm-4">
          <a href="/casino/ab2" className="game_img ">
            <img className="img-fluid" src="/img/banners/andar-bahar2.jpg" />
          </a>
         </div>
		 <div className="col-2 col-sm-4">
          <a href="/casino/andar-bahar" className="game_img">
            <img className="img-fluid" src="/img/banners/andar-bahar.jpg" />
          </a>
         </div>
