...
const ENDPOINT = "http://172.105.40.76:4002";
...
onTestClickFancySecond(e) {
   ...
   emptyHtml = () =>{
	...
	componentWillMount() {
		...
		axios.get(baseUrl + '/api/user-casino-deatils/onedayteenpatti', { headers }).then((resp) => {
	...
	callMatchOddsApi=(data)=>{
		...
		new_array['lasttime']=data.data.bf[0].lasttime;
		new_array['mid']=data.data.bf[0].marketId;
   ...
   <div className="col-md-9 featured-box-detail">
      <div className="coupon-card">
         <div className="game-heading">
            <span className="card-header-title"> 1 DAY TEENPATTI  <a href="#" className=" m-r-5 game-rules-icon blinking" data-id="match">RULES</a></span> 
