   ...
   <div className="col-md-9 featured-box-detail">
      <div className="coupon-card">
         <div className="game-heading">
            <span className="card-header-title"> INSTANT WORLI 
	...
	{timer}
            ...
            <div className={suspendcaino1} data-marketid="1.167146463">
               <table className="coupon-table worli-table table table-bordered mb-0">
                  ...
                  <tbody>
                     <tr>
                        <td className="text-center  box-w1 back"> <button className="d-block card-number" 
						...
						className="d-block card-number">5</span></td>
						 ...
						 <button className="back"
						  onClick={this.handleBidClick.bind(this,	"Line 1","9",'#faa9ba')}
						 
						 >	<span className="odd layprice"> Line 1</span>1|2|3|4|5</button>
						</td>
						   <td className="text-center  box-w1 back"> 
						 <button className="back"
						  onClick={this.handleBidClick.bind(this,	"EVEN","9",'#faa9ba')}
						 >	<span 
						
						 
						 className="odd layprice">EVEN</span>1|3|5|7|9</button>
						</td>
                     </tr>
					 <tr>
						<td className="text-center  box-w1 back"> <span
						...
						className="d-block card-number">0</span></td>
                        <td className="text-center  box-w1 back"> 
						 <button className="back"
						  onClick={this.handleBidClick.bind(this,	"Line 2","9",'#faa9ba')}
						 >	<span className="odd layprice"> Line 2</span>6|7|8|9|0</button>
						</td>
						 <td className="text-center  box-w1 back"> 
						 <button className="back"
						 onClick={this.handleBidClick.bind(this,	"EVEN","9",'#faa9ba')}
						 >	<span className="odd layprice"> EVEN</span>2|4|6|8|0</button>
						</td>
                     </tr>
