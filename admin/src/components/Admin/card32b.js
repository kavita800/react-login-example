   ...
   <div className="col-md-9 featured-box-detail">
      <div className="coupon-card">
         <div className="game-heading">
            <span className="card-header-title"> 32 CARDS  <a href="#" className=" m-r-5 game-rules-icon blinking" data-id="match">RULES</a></span> 
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td className="box-w1  lay suspended-casino">
                    ...
                    <button className="bet-sec lay"><span className="odd layprice"> 0.00</span>0</button>
                  </td>
                </tr>
                <tr>
            ...
            <table className="coupon-table table table-bordered">
              <thead>
                <tr>
                  ...
                  <th className="text-center  box-w1 lay"> Odd </th>
                </tr>
                <tr>
                  <td><span><strong>Player 8</strong></span><br />0</td>
                  <td className="box-w1  back-color suspended-casino">
				...
				<tr>
                  ...
                  <td className="box-w1   suspended-casino">
                    <button className="bet-sec "><span className="odd layprice">0.00</span>0.00</button>
                  </td>
                </tr>
				<tr>
                  <td><span><strong>Player 11</strong></span><br />0</td>
          ...
          <div className=" col-md-6">
            <table className="coupon-table table table-bordered">
              <tbody><tr>
                  <th class="w-5"> <i  className="fas fa-info-circle "></i></th>
                  <th className="text-center  box-w1 back"> BACK	</th>
                  <th className="text-center  box-w1 back"> LAY </th>
                </tr>
                <tr>
          ...
          <div className=" col-md-6">
            <table className="coupon-table table table-bordered">
			  ...
			  <tr>
                ...
                <tr>
                  <td><span className="pt-4 pb-4 dpinbl"><strong>8 & 9 Total</strong></span></td>
                  <td className="box-w1  back-color suspended-casino">
                    <div className="bet-info  " />
                    <button className="bet-sec "><span className="odd layprice"> 0.00</span>0</button>
                  </td>
