...
<div className="row game_img_man vip-poker">
        <div className="col-2 col-sm-4">
          <a href="casino/card32a" className="game_img ">
            <img className="img-fluid" src="/img/banners/32cardsA.jpg" />
          </a>
         </div>
		 <div className="col-2 col-sm-4">
          <a href="casino/card32b" className="game_img">
            <img className="img-fluid" src="/img/banners/32cardsB.jpg" />
          </a>
         </div>
