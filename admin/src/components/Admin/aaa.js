...
console.log(this.state.nation_7)
	...
	var newdata11=this.state.getResult11;
		...
		var suspendcaino3 ='card-image d-inline-block ';
   ...
   <div className="col-md-9 featured-box-detail">
      <div className="coupon-card">
         <div className="game-heading">
            <span className="card-header-title"> AMAR AKBAR ANTHONY <a href="#" className=" m-r-5 game-rules-icon blinking" data-id="match">RULES</a></span> 
            ...
            <div className="casino_video">
               <div className="video-overlay">
                  <div className="videoCards">
                     <div >
                        <h3  className="text-white">{this.state.nation}</h3>
                        <div ><img data-v-3e1a64f3 src="/img/card/patti_back.png" /> <img data-v-3e1a64f3 src="/img/card/patti_back.png" /> <img data-v-3e1a64f3 src="/img/card/patti_back.png" /></div>
                     </div>
                     <div>
                        <h3  className="text-white">{this.state.nation_2}</h3>
                        <div><img data-v-3e1a64f3 src="/img/card/patti_back.png" /> <img data-v-3e1a64f3 src="/img/card/patti_back.png" /> <img data-v-3e1a64f3 src="/img/card/patti_back.png" /></div>
                     </div>
                  </div>
               </div>
