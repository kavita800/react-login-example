...
<div className="row game_img_man vip-poker">
		 ...
		 <div className="col-2 col-sm-4">
          <a href="/casino/dt20 " className="game_img ">
            <img className="img-fluid" src="/img/banners/dt20.jpg" />
          </a>
         </div>
		 <div className="col-2 col-sm-4">
          <a href="/casino/dt-one-day" className="game_img">
            <img className="img-fluid" src="/img/banners/dt6.jpg" />
          </a>
         </div>
         </div>
