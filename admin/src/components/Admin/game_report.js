   ...
   <Header />
				<div id="wrapper">
					<div id="">
						...
						<h4 className="a_manh">Game Report</h4>
						<div className="">
      ...
      />
					 ...
					 <label>Type</label>
						...
						<label className="d_block h_14"></label>
                           <button className="btn btn22 btn-primary" value="submit" type="submit">Game List</button>
                        </div>
                        </div>
						
						 <div className="row">
					    <div className=" col-md-6">
					     <input className="form-control " type="text" placeholder="All" value=""  />
                        </div> 
                        
                       <div className="d-inline-block mr-2">
						
                           <button className="btn btn22 btn-primary" >Show Game Report</button>
                        </div>
                    <div className="d-inline-block ">
						
                           <button className="btn btn22 btn-primary" >Master Game Report</button>
                        </div>
                        ...
                        <div id="account-statement_wrapper" className="dataTables_wrapper ">
                           ...
                           <div className="">
                            ...
                            >
                              ...
                              <TableHeaderColumn dataField="username"   isKey={true} >
                              Name
                              </TableHeaderColumn>
