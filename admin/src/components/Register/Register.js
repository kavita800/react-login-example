...
const baseUrl = "http://172.105.49.136:4000";
			...
			<div className="card card-register mx-auto mmt-55 border-none">
			  ...
			  <div className="card-body">
				...
				<div className="text-center">
				  ...
				  <a className="d-block  mt-3" href="login.html">Login Page</a>
				  <a className="d-block " href="forgot-password.html">Forgot Password?</a>
				</div>
			  </div>
			</div>
		  </div>
