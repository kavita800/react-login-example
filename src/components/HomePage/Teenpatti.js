								...
								<div id="home" className="container tab-pane active">
									...
									<div className="coupon-card coupon-card-first">
										<div className="card-content" id="home_match_data">
											...
											<div className="row">
											<div className="col-md-6" style={{textAlign:'center'}}><img width="400" src={process.env.PUBLIC_URL+"/img/t20_teenpatti.jpg"} /></div>
											<div className="col-md-6" style={{textAlign:'center'}}><img width="400" src={process.env.PUBLIC_URL+"/img/oneday_teenpatti.jpg"} /></div>
											</div>
										</div>
									</div>
								</div>
