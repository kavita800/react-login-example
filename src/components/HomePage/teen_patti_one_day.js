...
onTestClickFancySecond(e) {
   ...
   emptyHtml = () =>{
	...
	// var randomIndex = Math.floor(Math.random() * new_array.length); 
		var randomElement ="http://139.162.197.173/teen1day/";
							...
							<div className="row">
								<div className="col-md-9 featured-box-detail">
									<div className="coupon-card"> 
										...
										<span className="card-header-title"> 1 DAY TEENPATTI  </span> 
										<span className="float-right m-r-10">Round ID: 202808183110 | Min: 100 | Max: 500000
...
<table className="coupon-table table table-bordered">
        <thead>
          <tr>
			...
			<th><span className="h6"> Match odds</span></th>
			  <th> &nbsp;</th>
			  <th> &nbsp;</th>
        ...
        <tbody>
          <tr>
            <td><span><strong>Player A</strong></span></td>
		  ...
		  <tr>
            <td><span><strong>Player B</strong></span></td>
			  <td className="box-w1  back2">
...
<table className="coupon-table table table-bordered">
        <thead>
          <tr>
			...
			<th><span className="h6">Pair Plus</span></th>
			  <th> &nbsp;</th>
			  <th> &nbsp;</th>
            <th className="text-center  box-w1 back"> BACK</th>
            <th className="text-center  box-w1 lay" style={{backgroundColor: 'rgb(114, 187, 239)'}}> LAY </th>
						   ...
						   <div className="form-group">
							...
							<label className="form-check-label">
							   <input className="" type="checkbox" /> Show bets for this event
									...
									<div className="card m-b-10 place-bet ">
										<div className="card-header">
											<h6 className="card-title d-inline-block">Pair Plus Rules</h6>
        ...
        <thead >
          <tr >
            <th  className="ng-scope" translate width="80%">Hands</th>
            <th  className="ng-scope" translate width="20%">Payout</th>
          </tr>
        </thead>
        <tbody >
          <tr >
            <td  className="ng-binding ng-scope">PAIR</td>
            <td  className="tr">1 To 1</td>
          </tr>
          <tr  className="odd">
            <td  className="ng-binding ng-scope">FLUSH</td>
            <td  className="tr">1 To 4</td>
          </tr>
          <tr >
            <td  className="ng-binding ng-scope">STRAIGHT</td>
            <td  className="tr">1 To 6</td>
          </tr>
          <tr  className="odd">
            <td  className="ng-binding ng-scope">TRIO</td>
            <td  className="tr">1 To 35</td>
          </tr>
          <tr >
            <td  className="ng-binding ng-scope">STRAIGHT FLUSH</td>
            <td  className="tr">1 To 45</td>
          </tr>
        </tbody>
      </table>
