							...
							<div className="row">
								<div className="col-md-9 featured-box-detail">
									<div className="coupon-card"> 
										...
										<span className="card-header-title">LUCKY 7 - A <a href="#" className=" m-l-5 game-rules-icon rules_a"  onClick={this.handleBidCrossClick123}>RULES</a></span> 
...
<div  class="row row5">		
	<div  className="col-md-6">
		...
		<div  className="col-6 text-center">
			...
			<div  className="m-t-10"><button onClick={this.handleBidClick.bind(this,this.state.nat_2,this.state.rate_2,'#faa9ba')} className={suspendcaino}><b >{this.state.nat_2}</b></button> <span  className="d-block m-t-5" style={{color: 'black'}}>0</span></div>
		</div>
		<div  className="col-6 text-center">
			<b >{this.state.rate_3}</b> 
			<div  className="m-t-10"><button onClick={this.handleBidClick.bind(this,this.state.nat_3,this.state.rate_3,'#faa9ba')}  className={suspendcaino}><b >{this.state.nat_3}</b></button> <span  className="d-block m-t-5" style={{color: 'black'}}>0</span></div>
		</div>
	...
	<div  className="col-md-6">
		...
		<div  className="col-6 text-center m-t-10">
			...
			<div  className="m-t-10">
				<button onClick={this.handleBidClick.bind(this,this.state.nat_4,this.state.rate_4,'#faa9ba')}  className={suspendcaino}>
			...
			<div  className="col-6 text-center m-t-10">
				...
				<div  className="m-t-10">
					<button onClick={this.handleBidClick.bind(this,this.state.nat_5,this.state.rate_5,'#faa9ba')}  className={suspendcaino}>
   ...
   <div  className="d-t-box">
      <div  className="row ">
         ...
         <div  className="card-dt col-md-12 text-center m-t-10">
            <div onClick={this.handleBidClick.bind(this,this.state.nat_6,this.state.rate_6,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/1.jpg" / ></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div   onClick={this.handleBidClick.bind(this,this.state.nat_7,this.state.rate_7,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/2.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div  onClick={this.handleBidClick.bind(this,this.state.nat_8,this.state.rate_8,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/3.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_9,this.state.rate_9,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/4.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_10,this.state.rate_10,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/5.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_11,this.state.rate_11,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/6.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_12,this.state.rate_12,'#faa9ba')}  className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/7.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_13,this.state.rate_13,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/8.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_14,this.state.rate_14,'#faa9ba')}  className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/9.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_15,this.state.rate_15,'#faa9ba')}  className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/10.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_16,this.state.rate_16,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/11.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div  onClick={this.handleBidClick.bind(this,this.state.nat_17,this.state.rate_17,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/12.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
            <div onClick={this.handleBidClick.bind(this,this.state.nat_18,this.state.rate_18,'#faa9ba')} className={suspendcaino1}>
               <div  className="m-r-5 m-l-5"><img  src="/img/card/13.jpg" /></div>
               <div  className="ubook text-center m-t-5"><b  style={{color: 'black'}}>0</b></div>
            </div>
         </div>
         <div  className="col-md-12 m-t-10 text-right"><span  className="m-r-10"><b >Min:
