...
onTestClickFancySecond(e) {
   ...
   emptyHtml = () =>{
	...
	// var randomIndex = Math.floor(Math.random() * new_array.length); 
		var randomElement ="http://139.162.197.173/poker";
							...
							<div className="row">
								<div className="col-md-9 featured-box-detail">
									<div className="coupon-card"> 
										...
										<span className="card-header-title">Poker </span> 
										<span className="float-right m-r-10">Round ID: 202908093003 | Min: 100 | Max: 200000
