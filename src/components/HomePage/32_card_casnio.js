...
onTestClickFancySecond(e) {
   ...
   emptyHtml = () =>{
	...
	// var randomIndex = Math.floor(Math.random() * new_array.length); 
		var randomElement ="http://139.162.197.173/32card/";
							...
							<div className="row">
								<div className="col-md-9 featured-box-detail">
									<div className="coupon-card"> 
										...
										<span className="card-header-title"> 32 CARDS - A  <a href="#" className=" m-r-5 game-rules-icon blinking" data-id="match">RULES</a></span> 
										<span className="float-right m-r-10">Round ID: 202808185953 | Min: 100 | Max: 100000
</span>
...
<table className="coupon-table table table-bordered">
        ...
        <tbody>
          <tr>
            <td><span><strong>Player 8</strong></span></td>
		  ...
		  <tr>
            <td><span><strong>Player 9</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Player 10</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Player 11</strong></span></td>
			  <td className="box-w1  back2">
