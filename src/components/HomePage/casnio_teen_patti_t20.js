...
const ENDPOINT = "http://172.105.40.76:4008";
			...
			return (<tr style={{ background: "#F3DCE2" }}>
				...
				<td style={{ width: "75px" }} >
					<div className="form-group">
						<input value={this.state.amountFancybetBal} name="amountFancybetBal" className="amountint" onChange={this.handleChange} type="number" style={{ float: "left", width: "50px", verticalAlign: "middle" }} id="odds" readOnly required="required" />
					</div>
				</td>
				<td>
...
//////console.log(SessInptNo);
	...
	var newdata11=this.state.getResult11;
		...
		var suspendcaino4 ='box-w1  back-color';
		...
		if(this.state.rate_4<=0){
			var suspendcaino4 ='box-w1  back-color suspended-casino';
		}
   ...
   <div className="col-md-9 featured-box-detail">
      <div className="coupon-card">
         <div className="game-heading">
            <span className="card-header-title"> Teen Patti T20  
            ...
            <div className=" m-b-10 main-market market-bf" data-marketid="1.167146463">
               <table className="coupon-table table table-bordered bg_light">
                  <thead>
                     <tr>
                        <th> &nbsp;</th>
                        <th className="text-center  box-w1 back" colspan="2"> BACK</th>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td className={suspendcaino1} >
                           ...
                           <button onClick={this.handleBidClick.bind(this,"back",this.state.nation,this.state.rate,'#faa9ba')}  className="bet-sec " >
                           <span className="odd layprice">  {this.state.rate}</span>
                           0</button>
                        </td>
                        <td className={suspendcaino2}>
                           <div className="bet-info  "></div>
                           <button className="bet-sec "  onClick={this.handleBidClick.bind(this,"lay",this.state.nation_1,this.state.rate_1,'#faa9ba')} >
                           <span className="odd layprice"> {this.state.nation_1}</span>
						  0</button>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td className={suspendcaino3} >
                           <div className="bet-info  "></div>
                           <button className="bet-sec " onClick={this.handleBidClick.bind(this,"lay",this.state.nation_2,this.state.rate_2,'#faa9ba')}>
                           <span className="odd layprice"> {this.state.rate_2}</span>
						   0</button>
                        </td>
                        <td className={suspendcaino4}>
                           <div className="bet-info  "></div>
                           <button className="bet-sec "  onClick={this.handleBidClick.bind(this,"lay",this.state.nation_3,this.state.rate_3,'#faa9ba')} >
                           <span className="odd layprice"> {this.state.nation_3}</span>
						 0 </button>
                        </td>
                     </tr>
                  </tbody>
...
<Modal show={this.state.showUserAmountPopup1} >
			...
			<img src="/img/tp-rules.jpg" width="100%"/><br/>
