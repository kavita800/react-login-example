...
onTestClickFancySecond(e) {
   ...
   emptyHtml = () =>{
	...
	// var randomIndex = Math.floor(Math.random() * new_array.length); 
		var randomElement ="http://139.162.197.173/7ud/";
							...
							<div className="row">
								<div className="col-md-9 featured-box-detail">
									<div className="coupon-card"> 
										...
										<span className="card-header-title">Seven Up Seven Down </span> 
										<span className="float-right m-r-10">Round ID: 200508174628
</span>
										
										 </div>
										<div className="card-content">
<div class="casino_video">
...
<div className=" mb-4 main-market market-bf">
<table className="coupon-table table table-bordered">
        ...
        <tbody>
          <tr>
            <td><span><strong>7Up</strong></span></td>
		  ...
		  <tr>
            <td><span><strong>7Down</strong></span></td>
			  <td className="box-w1  back2">
...
<table className="coupon-table table table-bordered">
        <thead>
          <tr>
			...
			<th><span className="h6">Colour</span></th>
			  <th> &nbsp;</th>
			  <th> &nbsp;</th>
            <th className="text-center  box-w1 back"> BACK</th>
            <th className="text-center  box-w1 lay" style={{backgroundColor: 'rgb(114, 187, 239)'}}> LAY </th>
        ...
        <tbody>
		  ...
		  <tr>
            <td><span><strong>Blabk</strong></span></td>
			  <td className="box-w1  back2">
...
<table className="coupon-table table table-bordered">
        <thead>
          <tr>
			...
			<th><span className="h6">Odd-Even</span></th>
			  <th> &nbsp;</th>
			  <th> &nbsp;</th>
            <th className="text-center  box-w1 back"> BACK</th>
            <th className="text-center  box-w1 lay" style={{backgroundColor: 'rgb(114, 187, 239)'}}> LAY </th>
        ...
        <tbody>
          <tr>
            <td><span><strong>Odd</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Even</strong></span></td>
			  <td className="box-w1  back2">
...
<div className=" m-b-4 main-market market-bf">
<table className="coupon-table table table-bordered">
        <thead>
          <tr>
           
			<th><span className="h6">Suit</span></th>
			  <th> &nbsp;</th>
			  <th> &nbsp;</th>
            <th className="text-center  box-w1 back"> BACK</th>
            <th className="text-center  box-w1 lay" style={{backgroundColor: 'rgb(114, 187, 239)'}}> LAY </th>
        ...
        <tbody>
          <tr>
            <td><span><strong>Club</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Diamond</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Heart</strong></span></td>
			  <td className="box-w1  back2">
		  ...
		  <tr>
            <td><span><strong>Spade</strong></span></td>
			  <td className="box-w1  back2">
