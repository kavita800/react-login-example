...
io.on("connection", (socket) => {
 ...
 // }
  interval = setInterval(() => getApiAndEmit14(socket), 1000);
...
var axios = require('axios');
	...
	var config = {
	  method: 'get',
	  url: 'http://172.105.49.149:8000/lordsexch/ab20/',
	  headers: { 
	...
	socket.emit("FromAPI14",{data:getData.data.data,data1:getData.data.result});
