...
io.on("connection", (socket) => {
 ...
 // }
  interval = setInterval(() => getApiAndEmit15(socket), 1000);
 ...
 const getApiAndEmit14= async socket => {
...
var axios = require('axios');
	...
	var config = {
	  method: 'get',
	  url: 'http://172.105.49.149:8000/lordsexch/card32eu/',
	  headers: { 
	...
	socket.emit("FromAPI15",{data:getData.data.data,data1:getData.data.result});
