...
io.on("connection", (socket) => {
 ...
 // }
  interval = setInterval(() => getApiAndEmit13(socket), 1000);
 ...
 const getApiAndEmit13= async socket => {
...
var axios = require('axios');
	...
	var config = {
	  method: 'get',
	  url: 'http://172.105.49.149:8000/lordsexch/aaa/',
	  headers: { 
	...
	socket.emit("FromAPI13",{data:getData.data.data,data1:getData.data.result});
