...
io.on("connection", (socket) => {
  ...
  //}
  interval = setInterval(() => getApiAndEmit3(socket), 1000);
...
var axios = require('axios');
	...
	var config = {
	  method: 'get',
	  url: 'http://172.105.49.149:8000/lordsexch/lucky7/',
	  headers: { 
	...
	var getData = await  axios(config);
	  ...
	  socket.emit("FromAPI7",{data:getData.data.data,data1:getData.data.result});
